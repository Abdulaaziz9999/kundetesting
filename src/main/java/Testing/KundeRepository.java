...
public class KundeRepository {
    ...
    public String lagreKunde(Kunde kunde) {
        String sql = "INSERT INTO Testing.Kunde (navn,adresse) VALUES(?,?)";
        try{
    ...
    public List<Kunde> hentAlleKunder() {
        String sql = "SELECT * FROM Testing.Kunde";
        try{
    ...
    public Kunde hentEnKunde(int id) {
        String sql = "SELECT * FROM Testing.Kunde WHERE id=?";
        try{
    ...
    public String endreEnKunde(Kunde kunde){
        String sql = "UPDATE Testing.Kunde SET navn=?,adresse=? where id=?";
        try{
    ...
    public String slettEnKunde(int id) {
        String sql = "DELETE FROM Testing.Kunde WHERE id=?";
        try{
            db.update(sql,id);
            return "OK";
        }
    ...
    public String slettAlleKunder () {
        String sql = "DELETE FROM Testing.Kunde";
        try{
            db.update(sql);
            return "OK";
        }
